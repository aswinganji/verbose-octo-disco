...
print("Number of Blocks Hacked: ",number_of_blocks)

# Write Task 02 code from below
print("Gene HAcked: ",blockchain.chain[0]['previous_hash'])
print("Hash Gene HacKed: ",blockchain.chain[0]['previous_hash'])
print("Prev Gene HackEd: ",blockchain.chain[1]['previous_hash'])

# Write Task 03 code from below
if blockchain.chain[0]['Current_hash'] == blockchain.chain[1]['previous_hash']:
	print("VErifyd HeckeD")

else :
	print("HaCked Not VErifyd")
